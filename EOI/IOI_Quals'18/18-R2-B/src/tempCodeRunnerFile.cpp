...
ll numPalindrome(int num);
ll constructPalindrome(int palPrefix, int numLength);
...
int main(void)
{
    ...
    while (n-- > 0) {
        scanf("%lld %lld", &a, &b);
        printf("%lld\n", b-a+1-(numPalindrome(b) - numPalindrome(a-1)));
    }
    return 0;
}
 ...
 */
ll constructPalindrome(ll palPrefix, ll numLength)
{
    ll front = palPrefix; // Starts at 1234, builds to 12340000
    ll back  = 0;         // Starts at 0   , builds to 4321
